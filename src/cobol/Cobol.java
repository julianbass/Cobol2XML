...
public class Cobol implements PubliclyCloneable {
	...
	protected HashMap<String, String> storedVariables = new HashMap<>();
	...
	/**
	 * Return the storedVariables of this COBOL program
	 *
	 * @return the variables stored of this COBOL program
	 */
	public HashMap<String, String> getStoredVariables() {
		return storedVariables;
	}


	/**
	 * Store a variable used in the COBOL program
	 *
	 * @param varName Name of the variable
	 * @param varType Type of the variable
	 */
	public void storeVariable(String varName, String varType){
		storedVariables.put(varName, varType);
	}
