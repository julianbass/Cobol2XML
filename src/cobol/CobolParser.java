...
import parse.tokens.PartialLiteral;
...
public class CobolParser {
	...
	protected Parser NumberVariable() {
		Sequence s = new Sequence();

		s.add(new Num());
		s.add(new Word());

		s.setAssembler(new NumberVariableAssembler());
